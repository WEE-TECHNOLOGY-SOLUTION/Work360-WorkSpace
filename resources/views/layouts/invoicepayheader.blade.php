...
<title>@yield('page-title') | {{ !empty($company_settings['title_text']) ? $company_settings['title_text'] : (!empty($admin_settings['title_text']) ? $admin_settings['title_text'] :'Work360') }}</title>
...
@endif
 ...
 <link rel="stylesheet" href="{{ asset('packages/Work360/Account/src/Resources/assets/css/nprogress.css') }}" >
<script src="{{ asset('packages/Work360/Account/src/Resources/assets/js/nprogress.js') }}"></script>
</head>
