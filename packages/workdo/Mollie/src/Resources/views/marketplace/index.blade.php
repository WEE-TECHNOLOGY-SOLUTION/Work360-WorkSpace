...
@php
    $path = url("vendor/workdo/mollie/src/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Your Mollie.com account allows you to select multiple Payment methods. However the Mollie Payment Gateway integrates with the iDeal payment method. This account has the "iDeal" and "Bank transfer" payment methods active, however only iDeal will be available to your users for payments.')}}</p>
                        <div class="price">
                ...
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-image-wrapper">
                        <div class="pdp-media banner-img-wrapper">
                            ...
                            <img src="{{$path.'/image2.png'}}" alt="" class="inner-frame-img">
                       </div>
                    </div>
                </div>
            </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Mollie')}}<b>{{__('Payment')}}</b>{{__('Gateway')}}</h2>
                <p>{{__('Your attendees can pay for their event registrations with a credit card or using services like IDEAL, Bancontact, SEPA Direct debit, Giropay, PayPal, Sofort Banking, and others.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('What is Mollie payment gateway?')}}</h2>
                        </div>
                        <p>{{__('
                            designed for growth. An advanced solution to accept payments, optimise conversion, and access funding. Sign up. Powering growth for over 130,000 businesses – from startups to enterprises.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('What does Mollie payments do?')}}</h2>
                        </div>
                        <p>{{__('Mollie is a leading European payment provider that specializes in processing online payments on behalf of merchants such as webshop owners. A pioneer in the payment industry, Mollie helps companies of all sizes accept different payment methods from customers with their robust yet simple payments API.')}}</p>
                    </div>
                </div>
            </div>
        </div>
