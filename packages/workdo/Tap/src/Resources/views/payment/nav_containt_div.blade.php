<div class="tab-pane fade" id="tap-payment" role="tabpanel" aria-labelledby="tap-payment">
    <form method="post" action="{{route('invoice.pay.with.tap')}}" class="require-validation" id="payment-form">
        @csrf
        @if($type == 'invoice')
