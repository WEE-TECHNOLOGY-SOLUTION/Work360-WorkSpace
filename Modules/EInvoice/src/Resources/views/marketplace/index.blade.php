    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('E-Invoice')}}<b>{{__('European')}}</b>{{__('Compliant Invoicing')}}</h2>
                <p>{{__('Right now this module supports EN 16931 Compliant Invoices, with CIUS – PEPPOL BIS. ')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('All Invoice exports are in XML.')}}</h2>
                        </div>
                        <p>{{__('Simply connect. When connected you will be able to send e-invoices on a global scale and become compliant with the newest regulations in Europe, Asia, North America and more. With over 50 countries already connected.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('E-Invoicing - European Compliant Invoicing')}}</h2>
                        </div>
                        <p>{{__('Do you still work with old systems that cannot connect to other networks yet? Our simple API allows you to connect to many e-invoicing networks and open exchange networks (i.e PEPPOL, BPC, SDI, Finvoice, FACeB2B, SAP, Tungsten).')}}</p>
                    </div>
                </div>
            </div>
        </div>
