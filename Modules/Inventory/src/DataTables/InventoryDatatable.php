...
namespace Workdo\Inventory\DataTables;
...
class InventoryDatatable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        $dataTable = (new EloquentDataTable($query))
            ->addIndexColumn();
            if (\Laratrust::hasPermission('inventory show'))
                {
                    $dataTable->addColumn('action', function (Inventory $inventory) {
                        return view('inventory::inventory.action_inventory', compact('inventory'));
                    });
                    $rowColumn[] = 'action';
                }
    ...
    {
       $model = $model->where('created_by', creatorId())->where('workspace', getActiveWorkSpace())->orderBy('id', 'desc');
       return $model;
    }
